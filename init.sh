...
# bash completion
BASH_COMP="ack base coreutils crontab eix eselect findutils gentoo git git-prompt gpg gpg2 iconv make man mdadm munin-node mysqladmin postfix rsync screen ssh subversion tar tmux vim"
